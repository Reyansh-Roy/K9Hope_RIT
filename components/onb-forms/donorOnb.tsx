...
const formSchema = z.object({
    ...
    d_weight_kg: z.preprocess(
        (val) => Number(val),
        z.number().min(20, { message: "Dog weight must be at least 20kg, to be eligible." })
    ),
                ...
                <Form {...form}>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 max-w-3xl mx-auto py-10">
                        ...
                        <div className="flex items-center justify-between space-x-1">
                            <h1 className="text-[25px] font-bold">🐕 You've logged in as a dog donor.</h1>
                            <button
                                type="button"
                        ...
                        <h1 className="text-[20px] font-bold text-center">Enter your dog's details to finish creating the account!</h1>

                        <h1 className="font-bold border-b-2 border-fg-500 pt-4 pb-2">Dog's Personal Details</h1>
                        <FormField
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>Enter your dog's name.</FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>Dog's Date of Birth (YYYY-MM-DD) *</FormLabel>
                                    <FormControl>
                                        <Popover>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>Dog's Gender *</FormLabel>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>Dog's Blood Group *</FormLabel>
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                        <FormControl>
                                            <SelectTrigger>
                                                <SelectValue placeholder="Select" />
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>Enter your dog's weight in kg (Kilograms).</FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>Enter full name of the person to be contacted in case of an emergency regarding your dog.</FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col items-start">
                                    ...
                                    <FormDescription>Enter their phone number that can be called in case of an emergency regarding your dog.</FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                        ...
                        <h1 className="font-bold border-b-2 border-fg-500 pt-4 pb-2">Dog's Medical History</h1>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="space-y-3">
                                    <FormLabel>Has your dog donated blood recently? *</FormLabel>
                                    <FormControl>
                        ...
                        < FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="space-y-3">
                                    <FormLabel>Is your dog on any medications? *</FormLabel>
                                    <FormControl>
                                        <div className="flex items-center space-x-3">
                                            <Switch
                                                checked={field.value === "yes"}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            Names of the medications your dog is currently taking.
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="space-y-3">
                                    <FormLabel>Is your dog regularly exposed to smoke? *</FormLabel>
                                    <FormControl>
                                        <div className="flex items-center space-x-3">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="space-y-3">
                                    <FormLabel>Has your dog been exposed to toxins/chemicals? *</FormLabel>
                                    <FormControl>
                                        <div className="flex items-center space-x-3">
                                            <Switch checked={field.value === "yes"} onCheckedChange={(checked) => field.onChange(checked ? "yes" : "no")} />
                                            <FormLabel className="font-normal">{field.value === "yes" ? "Yes" : "No"}</FormLabel>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="space-y-3">
                                    <FormLabel>Is your dog willing to be a regular donor? *</FormLabel>
                                    <FormControl>
                                        <div className="flex items-center space-x-3">
                                            <Switch checked={field.value === "yes"} onCheckedChange={(checked) => field.onChange(checked ? "yes" : "no")} />
                                            <FormLabel className="font-normal">{field.value === "yes" ? "Yes" : "No"}</FormLabel>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="space-y-3">
                                    <FormLabel>Will your dog be available in case of emergencies? *</FormLabel>
                                    <FormControl>
                                        <div className="flex items-center space-x-3">
                                            <Switch checked={field.value === "yes"} onCheckedChange={(checked) => field.onChange(checked ? "yes" : "no")} />
                                            <FormLabel className="font-normal">{field.value === "yes" ? "Yes" : "No"}</FormLabel>
